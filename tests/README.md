## How to test
The AI Agent Host was tested on Ubuntu 22.04, Ubuntu 24.04,  DietPi 8.20 and Dietpi 9.20.1. No other Linux distributions have been tested, but the instructions should be reasonably straightforward to adapt.
