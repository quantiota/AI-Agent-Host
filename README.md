...
3. Follow all prerequisite steps that should be completed before bringing the  Docker Stack. Refer to the Docker [Readme](https://github.com/BouarfaMahi/AI-Agent-Host/tree/main/docker) file for guidance
